...
Finally, I wanted to create two visualizations on my findings. For the first one, I decided to create a histogram that gave an accurate depiction of the biodiversity between counties. To make the histogram, I reused some of my previous code and labeled “unique species” for the x axis and “counties” for the y axis as this worked best. As you will see in both histograms, one major issue I had was that the names of the counties were bunching up, and I struggled to find any better fixes for this. But based on this visualization, it is clear that Suffolk County takes the lead with the most biodiversity by a long shot.
...
Finally, I created my second histogram with this information in the same format as the previous histogram to get an idea of what the numbers looked like. Suffolk county surprisingly also contains the most endangered species.
